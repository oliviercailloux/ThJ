...
\begin{frame}
	...
	\begin{itemize}
		\item To do
	\end{itemize}
  \citep{kymlicka_contemporary_2001}
\end{frame}
...
\begin{frame}
    ...
    \item Si on choisit des loisirs chers, et qu’on se ruine, devrait-on recevoir de la compensation ? \Citep{dworkin_matter_1985}
